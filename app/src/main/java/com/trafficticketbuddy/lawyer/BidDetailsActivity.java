...
public class BidDetailsActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ivLicense:
                FullImageZoomActivity.start(BidDetailsActivity.this, mCaseResponse.getDrivingLicense(), ivLicense);
                break;
            case R.id.ivBackImage:
                FullImageZoomActivity.start(BidDetailsActivity.this, mCaseResponse.getCaseRearImg(), ivBackImage);
                break;
            case R.id.ivFontImage:
                FullImageZoomActivity.start(BidDetailsActivity.this, mCaseResponse.getCaseFrontImg(), ivFontImage);
                break;
        }
    }
}
