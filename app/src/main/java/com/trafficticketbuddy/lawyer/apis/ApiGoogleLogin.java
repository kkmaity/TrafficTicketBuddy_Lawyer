...
public class ApiGoogleLogin {
    private OnApiResponseListener listener;
    private Map<String, String> param;

    public ApiGoogleLogin(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
    ...
    public void doWebServiceCall() {
        ...
        Call<LoginMain> data = RestService.getInstance().restInterface.Googlelogin(param);
