...
public class ApiFaceBookLogin {
    private OnApiResponseListener listener;
    private Map<String, String> param;

    public ApiFaceBookLogin(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
        this.listener = listener;
        doWebServiceCall();
    }
    public void doWebServiceCall() {
        Call<LoginMain> data = RestService.getInstance().restInterface.fblogin(param);
