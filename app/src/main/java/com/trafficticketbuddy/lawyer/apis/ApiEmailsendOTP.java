...
public class ApiEmailsendOTP {
    private OnApiResponseListener listener;
    private Map<String, String> param;

    public ApiEmailsendOTP(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
    ...
    public void doWebServiceCall() {
        ...
        Call<ResponseBody> getDepartment = RestService.getInstance().restInterface.send_mail_otp(param);
