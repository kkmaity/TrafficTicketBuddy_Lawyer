...
public class ApiSetViewed {
    private OnApiResponseListener listener;
    private Map<String, String> param;

    public ApiSetViewed(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
    ...
    public void doWebServiceCall() {
        ...
        Call<ResponseBody> getDepartment = RestService.getInstance().restInterface.setViewed(param);
