...
public class ApiEmailValidateOTP {
    private OnApiResponseListener listener;
    private Map<String, String> param;

    public ApiEmailValidateOTP(Map<String, String> param, OnApiResponseListener listener) {
        this.param = param;
    ...
    public void doWebServiceCall() {
        ...
        Call<ResponseBody> getDepartment = RestService.getInstance().restInterface.validate_email_otp(param);
