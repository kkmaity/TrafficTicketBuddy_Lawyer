...
import com.trafficticketbuddy.lawyer.MainActivity;
import com.trafficticketbuddy.lawyer.R;
import com.trafficticketbuddy.lawyer.model.homeBanner.Response;
...
public class AutoScrollPagerFragment extends Fragment {
  ...
  /*  private String[] imgs = {"http://h.hiphotos.baidu.com/image/w%3D1920%3Bcrop%3D0%2C0%2C1920%2C1080/sign=fed1392e952bd40742c7d7f449b9a532/e4dde71190ef76c6501a5c2d9f16fdfaae5167e8.jpg",
    ...
    private Toast toast;
    private List<Response> listImages;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        listImages= MainActivity.bannerList;
        ...
        pager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                title.setText(listImages.get(i).getDescription());
            }
        });
        ...
        pager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                ImageLoader.getInstance().displayImage(Constant.BASE_URL+listImages.get(position).getBannerImage(), view, options);
