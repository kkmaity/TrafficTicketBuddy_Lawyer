...
public class StateBaseAdapter extends BaseAdapter {
    private Context context; //context
    private List<StateNameResult>  items; //data source of the list adapter

    //public constructor
    public StateBaseAdapter(Context context, List<StateNameResult> response) {
