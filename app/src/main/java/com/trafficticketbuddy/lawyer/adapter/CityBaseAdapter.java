...
public class CityBaseAdapter extends BaseAdapter {
    ...
    private List<CityResponse>   items; //data source of the list adapter

    //public constructor
    public CityBaseAdapter(Context context, List<CityResponse> response) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewItemName.setText(items.get(position).getCity());
